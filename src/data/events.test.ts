...
test("getActiveHelpBonus", () => {
	const evts = [
		...
		new BonusEventData({
			name: "1st week",
			start: "2024-09-09T04:00:00",
			end: "2024-09-15T04:00:00",
			target: { type: ["water"] },
			effects: {
				skillTrigger: 1.5,
				skillLevel: 3,
	...
	expect(getActiveHelpBonus(new Date(2024, 8, 8, 3, 59, 0), evts).length).toBe(
		2,
	);
	expect(getActiveHelpBonus(new Date(2024, 8, 8, 4, 0, 0), evts).length).toBe(
		1,
	);
	expect(getActiveHelpBonus(new Date(2024, 8, 15, 3, 59, 0), evts).length).toBe(
		1,
	);
	expect(getActiveHelpBonus(new Date(2024, 8, 15, 4, 0, 0), evts).length).toBe(
		0,
	);

	expect(getActiveHelpBonus(new Date(2024, 8, 5), evts).length).toBe(2);
	expect(
		getActiveHelpBonus(new Date(2024, 8, 5), evts)[0].effects.skillLevel,
	).toBe(1);
	expect(
		getActiveHelpBonus(new Date(2024, 8, 5), evts)[1].effects.skillLevel,
	).toBe(3);
});
