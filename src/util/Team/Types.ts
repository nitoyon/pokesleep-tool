...
export interface IterationState {
	/** Pre-built per-member contexts (same order as the active members array). */
...
/**
 * Internal type for per-member simulation context and state.
 */
...
/**
 * Internal type for per-member simulation state that gets updated during the simulation loop.
 */
export interface MemberSimulationState {
