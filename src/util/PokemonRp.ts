	...
	get ingredientG(): number {
		return this.getOrCache("ingredientG", () => {
			const table = [
				...
				2.46, 2.519, 2.579, 2.64, 2.702, 2.765, 2.829, 2.894, 2.96, 3.027,
				3.095, 3.164, 3.234, 3.305, 3.377, 3.45, 3.524, 3.599, 3.675, 3.752,
				3.83, 3.909, 3.989, 4.07, 4.152, 4.235, 4.319, 4.404, 4.49, 4.577,
			];
