...
class PokemonRp {
    ...
    /** Sub-skill for level 10. */
    subSkill10: SubSkill|null;
    /** Sub-skill for level 25. */
    subSkill25: SubSkill|null;
    /** Sub-skill for level 50. */
    subSkill50: SubSkill|null;
    /** Sub-skill for level 75. */
    subSkill75: SubSkill|null;
    /** Sub-skill for level 100. */
    subSkill100: SubSkill|null;
    ...
    constructor(pokemonName: string) {
        ...
        this.skillLevel = 3;
        this.ingredient = "AAA";
        this.subSkill10 = this.subSkill25 = this.subSkill50 =
            this.subSkill75 = this.subSkill100 = null;
        this.nature = null;
    }
    ...
    get activeSubSkills(): SubSkill[] {
        const ret: SubSkill[] = [];
        if (this.level < 10) { return ret; }
        if (this.subSkill10 !== null) { ret.push(this.subSkill10); }

        if (this.level < 25) { return ret; }
        if (this.subSkill25 !== null) { ret.push(this.subSkill25); }

        if (this.level < 50) { return ret; }
        if (this.subSkill50 !== null) { ret.push(this.subSkill50); }

        if (this.level < 75) { return ret; }
        if (this.subSkill75 !== null) { ret.push(this.subSkill75); }

        if (this.level < 100) { return ret; }
        if (this.subSkill100 !== null) { ret.push(this.subSkill100); }
