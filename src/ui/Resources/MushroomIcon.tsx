    ...
    return (
        <svg width="24" height="24">
            <svg viewBox="0 0 200 200">
                ...
                <path d="M189.5,81.5c1.6,4.5,2.9,9.1,3.9,13.8,6.5,29.8-16.8,39.5-53.8,35.6-33.6-3.5-59.9,8.1-84.7,8.1s-47.4,0-49.4-35.5c-.2-3.2-.1-6.8.2-10.6C9.7,46.2,70,9,99.6,9s75.6,31.9,89.9,72.5Z" fill="none" stroke="#333" stroke-miterlimit="10" strokeWidth="7"/>
            </svg>
        </svg>
    );
});
