...
const ResearchCalcIcon = React.memo(() => {
	return (
		<svg width="48" height="48" role="img" aria-hidden={true}>
			...
			>
				<path
					d="M 0,-12 A 12 12 -90 1 1 0 12 A 12 12 90 1 1 0 -12 M 0,-6 A 6 6 -90 0 1 0 6 A 6 6 90 0 1 0 -6"
					stroke="#b9b9b9"
					fill="#cacaca"
				/>
				<path
					d="M 0,-12 A 12 12 -90 1 1 -10.39 6 L -5.196,3 A 6 6 210 1 0 0 -6 L 0,-12"
					stroke="#3683ee"
					fill="#1683ff"
				/>
			</g>
			<g transform="translate(6.9,7.2)">
