...
const PotIcon = React.memo((props: SvgIconProps) => {
	return (
		<SvgIcon {...props} viewBox="0 0 512 512">
			<path
				d="M218.856,98.781c4.859,1.75,12.844,4.656,12.844,11.5h48.578c0-6.844,8.016-9.75,12.875-11.5
                c5.344-1.906,16.813-9.938,16.813-22.813c0-20.375-20.234-35.391-53.969-35.391s-53.969,15.016-53.969,35.391
                C202.028,88.844,213.497,96.875,218.856,98.781z"
			></path>
			...
			<path
				d="M492.388,215.594c-10.813,0-32.813,0-44.516,0h-7.75H71.888h-7.766c-11.703,0-33.688,0-44.516,0
                ...
                C517.153,241.734,519.888,215.594,492.388,215.594z"
			></path>
		</SvgIcon>
	);
});
