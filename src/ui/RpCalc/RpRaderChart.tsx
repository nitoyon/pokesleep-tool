...
const RaderChartAxis = React.memo(({r}: {r: number}) => {
    ...
    const b = 2 / 3;
    return <>
        <g fill="#999" fontSize="70%">
            <text textAnchor="middle" x={x1} y={y1-10}>きのみ</text>
            <text textAnchor="end" dominantBaseline="hanging" x={x2+20} y={y2+5}>スキル</text>
            <text textAnchor="start" dominantBaseline="hanging" x={x3-20} y={y3+5}>食材</text>
        </g>
        <g stroke="#999">
