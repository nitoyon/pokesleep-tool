 ...
 */
const PwaBanner = React.memo(
	({ app, pwaCount, onClose, box }: PwaBannerProps) => {
			...
			<StyledPwaBanner open={open}>
				<div className="pwa_banner_container">
					...
					<div className="pwa_banner_body">
						...
						<Button className="later" onClick={onCloseClick}>
							{t("later")}
						</Button>
					</div>
...
const IPhoneMessageDialog = React.memo(
	({ app, open, onClose }: IPhoneMessageDialogProps) => {
			...
			<StyledIosPwaDialog open={open} onClose={onClose}>
				...
				<DialogContent dividers>
					<ol>
						<li>
							<Trans
								i18nKey="open in safari"
								components={{ safari: <SafariIcon /> }}
							/>
							<div>
								<Button onClick={onCopyUrl}>[{t("copy url")}]</Button>
							</div>
						</li>
						<li>
							<Trans
								i18nKey="push share icon"
								components={{ share: <IosShareIcon /> }}
							/>
						</li>
						<li>
							<Trans
								i18nKey="select add to home screen"
