...
export default function BetterSecondSleepDialog({
	open,
	onClose,
	data,
}: BetterSecondSleepDialogProps) {
	...
	for (let i = 0; i < 2; i++) {
		...
		details.push(
			<div className="better_preview" key={i}>
			...
			<StyledContent dividers className="better_dialog">
				<Trans
					...
					components={{
						...
						strength2: (
							<strong>
								{t("num", { n: data.second.strength - data.first.strength })}
							</strong>
						),
					}}
				/>
