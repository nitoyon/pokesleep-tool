...
const pokemonRectData: {[id: string]: RectElement[]} = {
    ...
    // Aron
    '304': [
        {x: 0, y: 0, w: 1, h: 1, color: '#f0f0f0'},
        {x: 0.1, y: 0.4, w: 0.3, h: 0.3, r: 0.2, color: '#343434'},
        {x: 0.6, y: 0.4, w: 0.3, h: 0.3, r: 0.2, color: '#343434'},
        {x: 0.3, y: 0.8, w: 0.14, h: 0.14, r: 0.2, color: '#343434'},
        {x: 0.56, y: 0.8, w: 0.14, h: 0.14, r: 0.2, color: '#343434'},
        {x: 0.49, y: 0, w: 0.02, h: 1, color: '#c3c5c3'},
    ],
    // Lairon
    '305': [
        {x: 0, y: 0, w: 1, h: 1, color: '#f0f0f0'},
        {x: 0, y: 0.5, w: 1, h: 0.6, color: '#868686'},
        {x: 0.1, y: 0.2, w: 0.2, h: 0.2, r: 0.2, color: '#343434'},
        {x: 0.4, y: 0.2, w: 0.2, h: 0.2, r: 0.2, color: '#343434'},
        {x: 0.7, y: 0.2, w: 0.2, h: 0.2, r: 0.2, color: '#343434'},
        {x: 0, y: 0.9, w: 1, h: 0.2, color: '#f0f0f0'},
    ],
    // Aggron
    '306': [
        {x: 0, y: 0, w: 1, h: 1, color: '#868686'},
        {x: 0, y: 0, w: 1, h: 0.3, color: '#f0f0f0'},
        {x: 0.6, y: 0.08, w: 0.15, h: 0.15, r: 0.15, color: '#343434'},
    ],
    // Gulpin
    '316': [
    ...
    // Shinx
    '403': [
        {x: 0, y: 0, w: 1, h: 1, color: '#96e1ff'},
        {x: 0, y: 0.85, w: 0.7, h: 0.08, color: '#ffe85b'},
        {x: 0.7, y: 0, w: 0.4, h: 1, color: '#555959'},
        {x: 0.25, y: 0.3, w: 0.15, h: 0.1, r: 0.1, color: '#fd6768'},
    ],
    // Luxio
    '404': [
        {x: 0, y: 0, w: 1, h: 1, color: '#424142'},
        {x: 0, y: 0.1, w: 1, h: 0.5, color: '#96e1ff'},
        {x: 0, y: 0.7, w: 1, h: 0.6, color: '#96e1ff'},
        {x: 0, y: 0.85, w: 1, h: 0.05, color: '#ffe85b'},
        {x: 0, y: 0.92, w: 1, h: 0.05, color: '#ffe85b'},
    ],
    // Luxray
    '405': [
        {x: 0, y: 0, w: 1, h: 1, color: '#424142'},
        {x: 0.1, y: 0.2, w: 0.55, h: 0.45, r: 0.2, color: '#96e1ff'},
        {x: 0.78, y: 0.7, w: 0.2, h: 0.2, r: 0.2, color: '#ffe85b'},
    ],
    // Bonsly
    '438': [
        {x: 0, y: 0, w: 1, h: 1, color: '#c1907a'},
    ...
    // Grubbin
    '737': [
        {x: 0, y: 0, w: 1, h: 1, color: '#eff9ff'},
        {x: 0.1, y: 0.26, w: 0.7, h: 0.44, r: 0.25, color: '#f67e2c'},
        {x: 0.1, y: 0.5, w: 0.7, h: 0.44, r: 0.25, color: '#855630'},
        {x: 0.1, y: 0.5, w: 0.7, h: 0.2, color: '#ffef85'},
    ],
    // Charjabug
    '738': [
        {x: 0, y: 0, w: 1, h: 1, color: '#7b9f42'},
        {x: 0.33, y: 0.33, w: 0.33, h: 0.66, color: '#d3d1cb'},
        {x: 0, y: 0.33, w: 0.34, h: 0.33, color: '#3481ad'},
        {x: 0.67, y: 0.33, w: 0.33, h: 0.33, color: '#3481ad'},
        {x: 0.03, y: 0.69, w: 0.27, h: 0.27, r: 0.165, color: '#fcd36a'},
        {x: 0.7, y: 0.69, w: 0.27, h: 0.27, r: 0.165, color: '#fcd36a'},
    ],
    // Vikavolt
    '739': [
        {x: 0, y: 0.15, w: 1, h: 0.2, color: '#b4aeae'},
        {x: 0.45, y: 0.65, w: 0.1, h: 0.1, color: '#eb9554'},
        {x: 0.1, y: 0.55, w: 0.8, h: 0.1, color: '#f5e257'},
        {x: 0.1, y: 0.45, w: 0.8, h: 0.1, color: '#6497b1'},
        {x: 0.35, y: 0.55, w: 0.1, h: 0.5, color: '#6497b1'},
        {x: 0.55, y: 0.55, w: 0.1, h: 0.5, color: '#6497b1'},
        {x: 0.25, y: 0.55, w: 0.1, h: 0.5, color: '#f5e257'},
        {x: 0.65, y: 0.55, w: 0.1, h: 0.5, color: '#f5e257'},
        {x: 0.3, y: 0.3, w: 0.4, h: 0.25, color: '#6497b1'},
        {x: 0, y: 0, w: 0.3, h: 0.35, color: '#6497b1'},
        {x: 0.7, y: 0, w: 0.3, h: 0.35, color: '#6497b1'},
    ],
    // Stufful
    '759': [
