...
const pokemonRectData: { [id: string]: RectElement[] } = {
	...
	// Metapod
	"11": [{ x: 0, y: 0, w: 1, h: 1, color: "#b8d777" }],
	// Butterfree
	"12": [
	...
	// Ekans
	"23": [{ x: 0, y: 0, w: 1, h: 1, color: "#c499ec" }],
	// Arbok
	"24": [
	...
	// Sandshrew
	"27": [
		{ x: 0, y: 0, w: 1, h: 1, color: "#e6d559" },
		{ x: 0.2, y: 0.5, w: 0.6, h: 0.8, r: 0.3, color: "#f9edde" },
	],
	// Sandslash
	"28": [
		{ x: 0, y: 0, w: 1, h: 1, color: "#e6d55b" },
		{ x: 0.3, y: 0.55, w: 0.4, h: 0.8, r: 0.3, color: "#f9edde" },
		{ x: 0, y: 0, w: 1, h: 0.2, color: "#af8242" },
	],
	// Clefairy
	"35": [
	...
	// Ninetales
	"38": [{ x: 0, y: 0, w: 1, h: 1, color: "#ffffce" }],
	// Ninetales (Alola)
	"12326": [
	...
	// Jigglypuff
	"39": [{ x: 0, y: 0, w: 1, h: 1, color: "#fce3ea" }],
	// Wigglytuff
	"40": [
	...
	// Geodude
	"74": [{ x: 0, y: 0, w: 1, h: 1, color: "#bfc0b5" }],
	// Graveler
	"75": [
	...
	// Onix
	"95": [{ x: 0, y: 0, w: 1, h: 1, color: "#b5b3b6" }],
	// Cubone
	"104": [
	...
	// Igglybuff
	"174": [{ x: 0, y: 0, w: 1, h: 1, color: "#fef2f2" }],
	// Togepi
	"175": [
	...
	// Heracross
	"214": [{ x: 0, y: 0, w: 1, h: 1, color: "#5f87ae" }],
	// Sneasel
	"215": [
	...
	"244": [
		...
		{ x: 0.5, y: 0, w: 0.7, h: 0.4, color: "#f7fef8" },
	],
	// Suicune
	"245": [
		{ x: 0, y: 0, w: 1, h: 1, color: "#63eaf9" },
		{ x: 0, y: 0, w: 0.5, h: 0.3, color: "#0fcce3" },
		{ x: 0.5, y: 0, w: 0.7, h: 0.5, color: "#9284d5" },
	],
	// Larvitar
	"246": [
	...
	// Pupitar
	"247": [{ x: 0, y: 0, w: 1, h: 1, color: "#89a5d0" }],
	// Tyranitar
	"248": [
	...
	"254": [
		...
		{ x: 0.2, y: 0.12, w: 0.15, h: 0.15, r: 0.15, color: "#f9e088" },
	],
	// Torchic
	"255": [
	...
	// Shuppet
	"353": [{ x: 0, y: 0, w: 1, h: 1, color: "#878bb7" }],
	// Banette
	"354": [
	...
	"764": [
		...
		{ x: 0, y: 0.3, w: 0.42, h: 0.42, r: 0.05, color: "#f0f49a" },
