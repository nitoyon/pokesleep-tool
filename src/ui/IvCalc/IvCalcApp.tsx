...
import { Tab, Tabs, Button, Snackbar } from '@mui/material';
...
const ResearchCalcApp = React.memo(() => {
    ...
    const isSelectedItemEdited = selectedItem !== null && !selectedItem.iv.isEqual(state.pokemonIv);
    ...
    return (
        <>
            ...
            >
                ...
                {state.pokemonIv.pokemon.ratioNotFixed && (
                    <div
                        style={{
                    ...
                    >
                        {t('ratio is not fixed')}
                    </div>
                )}
                <LowerTabHeader
                    upperTabIndex={state.tabIndex}
                    tabIndex={state.lowerTabIndex}
