				...
				<article>
					...
					<FormControlLabel
						control={
							<Checkbox
								size="small"
								checked={param.addHelpingBonusEffect}
								onChange={onHelpingBonusEffectChange}
							/>
						}
