	...
	({
		...
		return (
			...
			>
				...
				<MenuItem value={8} dense>
					{t("8hours")}
				</MenuItem>
				<MenuItem value={16} dense>
					{t("16hours")}
				</MenuItem>
				<MenuItem value={24} dense>
					{t("1day")}
				</MenuItem>
				<MenuItem value={168} dense>
					{t("1week")}
				</MenuItem>
				...
				<MenuItem value={-100} dense>
					{t("help x100")}
				</MenuItem>
				<MenuItem value={whistlePeriod} dense>
					{t("whistle")}
				</MenuItem>
			</SelectEx>
		);
